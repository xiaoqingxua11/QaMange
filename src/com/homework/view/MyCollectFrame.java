 ...
 * Package:    com.homework.view
 * Description:
 * Datetime:    2020/9/25   11:41
 * Author:   ${小情绪}
 */
public class MyCollectFrame extends JFrame {
    //头部
    ...
    public MyCollectFrame(int user_id) {
        curId=user_id;
        this.setTitle("我的收藏");
        ...
        //中间组件
        jtable = new JTable(new TableModel(qusetionService.getCollectedQusetionByUser_id(pageNum,key,user_id)));
        ...
        ActionListener listener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (e.getActionCommand().equals("首页")) {
                    if (pageNum == 1) {
                        JOptionPane.showMessageDialog(MyCollectFrame.this, "已经是第一页啦");
                    } else {
                        pageNum = 1;
                    ...
                    key = keyLableField.getText();
                    int maxPage = qusetionService.getMaxPageById(key,String.valueOf(user_id));
                    if (pageNum < maxPage-1) {
                        pageNum = pageNum + 1;
                        jPage.setText(String.valueOf("第" + pageNum + "页"));
                        update();
                    } else {
                        JOptionPane.showMessageDialog(MyCollectFrame.this, "已经是最后一页啦！");
                    }
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(MyCollectFrame.this, "请先选择表格内容！");
                    }
    ...
    public void update() {
        this.remove(jsp);
        jtable = new JTable(new TableModel(qusetionService.getCollectedQusetionByUser_id(pageNum,key,curId)));
        jsp = new JScrollPane(jtable);
        this.add(jsp,"Center");
        this.setVisible(true);
    }
